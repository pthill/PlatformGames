...
private:
	...
	//绘画数字
	void DrawNumberStringWithSpace(CDC * pDC, CString szNumber, INT nXPos, INT nYPos);
	//绘画数字
	void DrawNumberStringWithSpace(CDC * pDC, CString szNumber, CRect rcRect, INT nFormat=-1,bool bBig = false);
	//绘画标识
